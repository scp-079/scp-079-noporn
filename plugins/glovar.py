...
try:
    ...
    noporn_channel_id = int(config["channels"].get("noporn_channel_id", str(noporn_channel_id)))
    ...
    threshold_porn = float(config["custom"].get("threshold_porn", str(threshold_porn)))
